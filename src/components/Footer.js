        ...
        <div className="footer-container">
          ...
          <div className="footer-col contact-col">
            ...
            <div className="contact-card">
              <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="#C8191E" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
              <p>4/122 A Chinneri Vayal Kadu, Pallapatti, Salem, Tamil Nadu - 636009</p>
            </div>
            <div className="contact-card">
              <svg className="contact-icon" viewBox="0 0 24 24" fill="#C8191E"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
              <a href="tel:+919345243443">+91 93452 43443</a>
            </div>
            <div className="contact-card">
              <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="#C8191E" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              <p>Open 24 Hours</p>
